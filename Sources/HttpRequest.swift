...
open class HttpRequest {
    ...
    open func hasTokenForHeader(_ headerName: String, token: String) -> Bool {
    ...
    open func parseUrlencodedForm() -> [(String, String)] {
    ...
    public struct MultiPart {
        ...
        fileprivate func valueFor(_ headerName: String, parameter: String) -> String? {
    ...
    open func parseMultiPartFormData() -> [MultiPart] {
        guard let contentTypeHeader = headers["content-type"] else {
            return []
        }
        let contentTypeHeaderTokens = contentTypeHeader.split(";").map { $0.trim() }
